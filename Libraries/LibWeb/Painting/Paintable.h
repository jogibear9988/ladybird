...
public:
    ...
    CSSPixelPoint transform_point_to_viewport(CSSPixelPoint point, AccumulatedVisualContextTree::IncludeVisualViewportTransform = AccumulatedVisualContextTree::IncludeVisualViewportTransform::Yes) const;
    Optional<CSSPixelPoint> transform_point_from_viewport(CSSPixelPoint point, AccumulatedVisualContextTree::IncludeVisualViewportTransform = AccumulatedVisualContextTree::IncludeVisualViewportTransform::Yes) const;
